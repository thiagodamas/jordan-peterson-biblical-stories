...
echo ""
echo "Reextraindo todas as 16 palestras para a estrutura moderna (EN/)..."
python3 scripts/extract_transcript.py --all --lang en --output-dir "Biblical Stories/EN"

echo ""
echo "Baixando covers para EN/..."
python3 scripts/download_covers.py --all --lang en --output-dir "Biblical Stories/EN"

echo ""
echo "=== Extração e covers concluídos! ==="
echo ""
...
echo ""
echo "Para executar manualmente (recomendado):"
echo "  python3 scripts/extract_transcript.py --all --lang en --output-dir \"Biblical Stories/EN\""
echo "  python3 scripts/download_covers.py --all --lang en --output-dir \"Biblical Stories/EN\""
echo ""
echo "Para PT-BR (se necessário):"
echo "  python3 scripts/extract_transcript.py 1 --lang pt --output-dir \"Biblical Stories/PT-BR\""
